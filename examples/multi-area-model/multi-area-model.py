...
B.plot_fractions(
    axis=ax1,
    fill_variables=["wall_time_create+wall_time_connect", "wall_time_sim"],
    interpolate=True,
    step=None,
    error=True,
)
...
B.plot_fractions(axis=ax3, fill_variables=["frac_phase_communicate", "frac_phase_update", "frac_phase_deliver"])
